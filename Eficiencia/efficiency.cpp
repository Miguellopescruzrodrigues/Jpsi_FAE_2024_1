...
string quantity = "Pt";     double bins[] = {2.0, 3.4, 4.0, 4.4, 5.0, 5.6, 5.8, 6.0, 6.2, 6.4, 6.6, 6.8, 7.3, 9.5, 13.0, 17.0, 20.};
...
void efficiency()
{
	...
	//Create efficiencies
	generatedFile->   cd("/");
	get_efficiency(yield_all, yield_pass, quantity, nbins, MuonId, "", true);
